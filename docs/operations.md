...
`ion-gfx-ray-scope` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for ray systems, covering event replay, fixture event logs, and failure-oriented tests.
