...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-gfx-ray-detail.ps1

dart tests/test_domain_review.dart

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-gfx-ray-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-gfx-ray-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion_gfx_ray_scope-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
