"""Regression checks for the ion-gfx-ray-scope casebook."""
...
from casebook.harness import assert_expected, ion_gfx_ray_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_gfx_ray_scope_summary(), assert_expected())
